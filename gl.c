...
static void  GL_APIENTRY _impl_glFramebufferTextureLayerARB (GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer) {
  _glptr_glFramebufferTextureLayerARB = (PFN_glFramebufferTextureLayerARB)GalogenGetProcAddress("glFramebufferTextureLayerARB");
   _glptr_glFramebufferTextureLayerARB(target, attachment, texture, level, layer);
}
PFN_glFramebufferTextureLayerARB _glptr_glFramebufferTextureLayerARB = _impl_glFramebufferTextureLayerARB;

static void  GL_APIENTRY _impl_glProgramParameteriARB (GLuint program, GLenum pname, GLint value) {
  _glptr_glProgramParameteriARB = (PFN_glProgramParameteriARB)GalogenGetProcAddress("glProgramParameteriARB");
   _glptr_glProgramParameteriARB(program, pname, value);
}
PFN_glProgramParameteriARB _glptr_glProgramParameteriARB = _impl_glProgramParameteriARB;
...
static void  GL_APIENTRY _impl_glFramebufferTextureARB (GLenum target, GLenum attachment, GLuint texture, GLint level) {
  _glptr_glFramebufferTextureARB = (PFN_glFramebufferTextureARB)GalogenGetProcAddress("glFramebufferTextureARB");
   _glptr_glFramebufferTextureARB(target, attachment, texture, level);
}
PFN_glFramebufferTextureARB _glptr_glFramebufferTextureARB = _impl_glFramebufferTextureARB;
...
static void  GL_APIENTRY _impl_glFramebufferTextureFaceARB (GLenum target, GLenum attachment, GLuint texture, GLint level, GLenum face) {
  _glptr_glFramebufferTextureFaceARB = (PFN_glFramebufferTextureFaceARB)GalogenGetProcAddress("glFramebufferTextureFaceARB");
   _glptr_glFramebufferTextureFaceARB(target, attachment, texture, level, face);
}
PFN_glFramebufferTextureFaceARB _glptr_glFramebufferTextureFaceARB = _impl_glFramebufferTextureFaceARB;
